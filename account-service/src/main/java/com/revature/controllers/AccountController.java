...
public class AccountController {
	...
	public AccountController() {
		...
		accounts.add(new Account(2, 1, "account 1", 80));
		accounts.add(new Account(3, 2, "account 1", 90));
		accounts.add(new Account(4, 1, "account 1", 100));
		accounts.add(new Account(5, 1, "account 1", 78));
	}
